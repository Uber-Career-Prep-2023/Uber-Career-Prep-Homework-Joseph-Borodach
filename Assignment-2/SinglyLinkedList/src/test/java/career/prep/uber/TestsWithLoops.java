...
public class TestsWithLoops {

    /**
     * For simplicity, my tests assumed no duplicate nodes.
     * These are the original tests I wrote.
     * I was unsure if using for loops in testing is less preferable because it is less clear and epxplicit.
     * So, I wrote the other set of tests.
     */
    @Test
